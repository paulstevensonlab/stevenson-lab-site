  ...
  <div>
    ...
    <section className="min-h-screen flex items-center px-16 relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: 'url("images/hero/spin_laser-01.png")',
...
const ImageCarousel = () => {
  const images = [
    { src: '/images/research/tirf.jpg', alt: 'NV fluorescence' },
    { src: '/images/research/lasers.jpg', alt: 'Laser setup' },
    { src: '/images/research/acid.jpeg', alt: 'Triacid cleaning' },
  ];
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-3xl font-light text-gray-900 mb-4">The NV Center</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div>
                  <img 
                    src="/images/research/NVpicture.png" 
        ...
        sections: [
          {
            ...
            image: "/images/research/spinwaves.png"
          },
          {
            ...
            image: "/images/research/cycloid_knot.png"
          }
        ]
      }
    },
        ...
        sections: [
          {
            ...
            image: "/images/research/ciss.png"
          },
        ]
      }
    },
        ...
        sections: [
          {
            ...
            image: "/images/research/frap.png"
          },
          {
            heading: "Nanoscale magnetic resonance",
            text: "Coming soon!",
            image: "/images/research/protein-dynamics.jpg"
          }
        ]
      }
    }
    ...
    <div className="px-16 py-12">
      ...
      <section className="mb-16">
        ...
        <div className="bg-white p-8 flex space-x-8">
          <img 
          src="/images/team/pi/NUheadshot.jpg" 
            alt="Dr. Stevenson"
